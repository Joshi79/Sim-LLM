...
def create_temporal_correlation_heatmap(real_df,synthetic_df,all_cols,patient_col= "user_id",pretty= None):
    ...
    # Save trend figure
    plt.savefig('../../reports/output_data_fidelity/temporal_correlation_trends_test_basline_prompt.pdf', format='pdf', dpi=1200, bbox_inches='tight')
    #plt.show()
    ...
    # Save cycle figure
    plt.savefig('../../reports/output_data_fidelity/temporal_correlation_cycles_test_baseline_prompt.pdf', format='pdf', dpi=1200, bbox_inches='tight')
...
synthetic_path_no_orignal_data_info = "../../data/prompt_no_info_orignal_data.csv"
synthetic_path_not_grounded_in_synthetic = "../../data/prompt_not_grounded_in_synthetic.csv"
synthetic_baseline = "../../data/synthetic_data_baseline_prompt.csv"
